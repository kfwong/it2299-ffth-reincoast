...
import com.it2299.ffth.reincoast.dao.CalendarEventPlannerDao;
 ...
 */
@WebServlet("/CalendarEventPlannerServlet")
public class CalendarEventPlannerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CalendarEventPlannerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action!= null){
			if(action.equals("getCalendar")){
				ArrayList<CalendarEventPlanner> foodDriveArray;
				
				CalendarEventPlannerDao dao = new CalendarEventPlannerDao();
				foodDriveArray = (ArrayList<CalendarEventPlanner>) dao.getAll();
			...
			if(action.equals("view")){
				...
				CalendarEventPlanner fd = new CalendarEventPlanner();
			...
			if(action.equals("getContacts")){	
				VolunteerDao cd = new VolunteerDao();
				ArrayList<Volunteer> contactArrayList= (ArrayList<Volunteer>) cd.getAll();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action != null){
			...
			if(action.equals("create")){
				...
				Volunteer contact = new Volunteer();
		...
		response.sendRedirect("schedule-eventplanner.jsp");
	}
