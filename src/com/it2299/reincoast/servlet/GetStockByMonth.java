...
/**
 * Servlet implementation class GetStockByMonth
 */
@WebServlet("/GetStockByMonth")
public class GetStockByMonth extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetStockByMonth() {
        super();
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		int inboundSize = inboundDao.getByMonth().size();
		...
		int outboundSize = outboundDao.getByMonth().size();
		...
		String chart = "Morris.Line({element: 'graph',";
	    	 chart = chart + "data:[";
	    	  ...
	    	  chart = chart + generatedChart(size,  inboundDao.getByMonth(), outboundDao.getByMonth());
