...
/**
 * Servlet implementation class GetStockByYear
 */
@WebServlet("/GetStockByYear")
public class GetStockByYear extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetStockByYear() {
        super();
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		int inboundSize = inboundDao.getByYear().size();
		...
		int outboundSize = outboundDao.getByYear().size();
		...
		String chart = "Morris.Bar({element: 'graph',";
	    	 chart = chart + "data:[";
	    	  ...
	    	  chart = chart + generatedChart(size,  inboundDao.getByYear(), outboundDao.getByYear());
