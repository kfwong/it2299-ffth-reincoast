	    ...
	    <div class="modal-content">
			<form role="form" method="post" action="CalendarEventPlannerServlet">
		      ...
		      <div class="modal-body">
				...
				<div class="form-group">
				  <label for="contact">Volunteer</label>
...
<script>
	$(document).ready(function(){
		$('#calendar').fullCalendar({
			...
			events: "CalendarEventPlannerServlet?action=getCalendar",
		    ...
		    eventClick: function(calEvent, jsEvent, view) {
		    	$.ajax({
		    		type: "GET",
		    		url: "CalendarEventPlannerServlet?action=view&id=" + calEvent.id,
		    ...
		    eventDrop: function(event, revertFunc) {
		    	$.ajax({
		    		type: "POST",
		    		url: "CalendarEventPlannerServlet",
		    		data: {
		    			action:"edit",
		    	        id: event.id,
		    	        title: event.title,
        ...
        $.ajax({
    		type: "GET",
    		url: "CalendarEventPlannerServlet?action=getContacts",
    		success: function(json){
