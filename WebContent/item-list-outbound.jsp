				...
				<div class="panel-heading">
					<div id="printOut">
						<h3 class="panel-title">
							<label>Inbound ID: ${outbound.id}</label>
						</h3>
						<h3 class="panel-title">
							<label>Collection Center: ${outbound.collectionCenter}</label>
						</h3>
						<h3 class="panel-title">
							<label>Total Value: ${outbound.totalPrice}</label>
						</h3>
						<h3 class="panel-title">
							<label>Sended: ${outbound.dateDelivered}</label>
						</h3>
