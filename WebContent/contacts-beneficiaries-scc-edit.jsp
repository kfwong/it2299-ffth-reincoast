...
<jsp:include page="sidebar.jsp">
	...
	<jsp:param value="Beneficiaries - S.C.C." name="sub-active" />
</jsp:include>
<!-- sidebar.jsp -->

<!-- content -->
<div id="page-wrapper">
	<h1>Contacts <small>Beneficiaries - Self Collection Center</small></h1>
		...
		<table class="table table-hover table-striped table-bordered">
			<thead>
				<tr>
					...
					<th class="table-column-organization">Self Collection Center</th>
				</tr>
			</thead>
...
<script>
	$(document).ready(function(){
		...
		$(".discard-button").on("click", function(){
			window.location.href = 'ContactServlet?type=scc';	
		});
